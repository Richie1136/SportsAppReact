...
const Team = () => (
  <div style={{ 'display': 'flex', 'flexWrap': 'wrap', 'justifyContent': 'space-evenly' }}>
    {teamData?.queryResults.row.map(({ StadiumID, team_id, website_url, logo, name_display_full, address_line1, address_city, address_state, address_zip, phone_number, venue_name }) => (
